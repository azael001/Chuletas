    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            try {
                ...
                PreparedStatement stmt = coneccion().prepareStatement(sqlSentence1);
                ...
                PreparedStatement stmt2 = coneccion().prepareStatement(sqlSentence2);
                ...
                PreparedStatement stmt3 = coneccion().prepareStatement(sqlSentence3);
                ...
                PreparedStatement stmt4 = coneccion().prepareStatement(sqlSentence4);
                ...
                PreparedStatement stmt5 = coneccion().prepareStatement(sqlSentence5);
                ...
                PreparedStatement stmtUpdate = coneccion().prepareStatement(sqlUpdate);
            ...
            try{
                ...
                PreparedStatement prepareCall = coneccion().prepareCall(sqlPrueba);
...
//            Update que reaccionará el trigger
                ...
                PreparedStatement stmtUpdate = coneccion().prepareStatement(sqlUpdateTrigger);
                stmtUpdate.executeUpdate();
